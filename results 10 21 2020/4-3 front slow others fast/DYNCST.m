...
%         end
         ...
         C=dx_1+vref_road-vref-10*param.len;
            ...
            vref=floor(obstacle(index).traj(4,i)+abs((vref_road+0.1-obstacle(index).traj(4,i))*tanh(0.01*dx_1+0.2*dx_2)));%+0.2*dx_2
            %vref=15.;
