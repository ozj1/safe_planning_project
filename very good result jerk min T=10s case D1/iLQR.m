...
T = 10;             ... total job length%Omid it was 20 previously
...
if plot_gif == 1
    ...
    %     hold on
        p = plot(X_local(1,1:35,i), X_local(2,1:35,i), 'b--*');%this shows the the future position of ego vehicle as well
        hold on
...
%              for jj = 1:NUM_CTRL% added by Omid
             lp = plot(obs_long(1,:,i,hh), obs_long(2,:,i,hh), 'c*');
%              end
            end
