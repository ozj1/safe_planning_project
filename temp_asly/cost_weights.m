...
global w_jerk w_acc w_del w_ref w_vel w_end_ref w_end_acc w_end_vel w_jerk_end w_del_end
...
% % w_ref       = 10;... 3
% % w_vel       = 0.1;
% % w_ref = 4.* ones(NUM_CTRL,1);
% % w_vel = 0.1* ones(NUM_CTRL,1);
% % w_acc = 0.5* ones(NUM_CTRL,1);
% 
% w_end_ref   = 10;
% w_end_acc   = 10;
% w_end_vel   = 10;
